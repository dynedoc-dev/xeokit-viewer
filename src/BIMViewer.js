     ...
     <div class="xeokit-tab xeokit-storeysTab">
        ...
        <div class="xeokit-tab-content">
         <div class="xeokit-btn-group">
             ...
             <div id="treePanelBIM" class="xeokit-storeys xeokit-tree-panel"></div>
        </div>
    </div>
</div>`;
...
function createToolbarTemplate(cfg = {}) {
    ...
    <!-- Reset button -->
    <div class="xeokit-btn-group">
        <button type="button" class="xeokit-i18n xeokit-reset xeokit-btn fixedWidthHeightTooltipBtn fa fa-home fa-2x disabled" data-xeokit-i18ntip="toolbar.resetViewTip" data-tippy-content="Reset view"></button>
    </div>
    <div class="xeokit-btn-group" role="group">
        <!-- 3D Mode button -->
        <button type="button" class="xeokit-i18n xeokit-threeD xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-cube fa-2x disabled" data-xeokit-i18ntip="toolbar.toggle2d3dTip" data-tippy-content="Toggle 2D/3D"></button>
        <!-- Perspective/Ortho Mode button -->
        <button type="button" class="xeokit-i18n xeokit-ortho xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-th fa-2x  disabled" data-xeokit-i18ntip="toolbar.togglePerspectiveTip" data-tippy-content="Toggle Perspective/Ortho"></button>
        <!-- Fit button -->
        <button type="button" class="xeokit-i18n xeokit-fit xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-crop fa-2x disabled" data-xeokit-i18ntip="toolbar.viewFitTip" data-tippy-content="View fit"></button>
        <!-- First Person mode button -->
        <button type="button" class="xeokit-i18n xeokit-firstPerson xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-male fa-2x disabled" data-xeokit-i18ntip="toolbar.firstPersonTip" data-tippy-content="Toggle first-person mode"></button>
          <!-- Show/hide IFCSpaces -->
        <button type="button" class="xeokit-i18n xeokit-showSpaces xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-vector-square fa-2x disabled" data-xeokit-i18ntip="toolbar.showSpacesTip" data-tippy-content="Show IFCSpaces"></button>   
    </div>
    <!-- Tools button group -->
    <div class="xeokit-btn-group" role="group">
        <!-- Hide tool button -->
        <button type="button" class="xeokit-i18n xeokit-hide xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-eraser fa-2x disabled" data-xeokit-i18ntip="toolbar.hideObjectsTip" data-tippy-content="Hide objects"></button>
        <!-- Select tool button -->
       <!-- <button type="button" class="xeokit-i18n xeokit-select xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-mouse-pointer fa-2x disabled" data-xeokit-i18ntip="toolbar.selectObjectsTip" data-tippy-content="Select objects" style="display:none;"></button>   -->
	<!-- <button type="button" class="xeokit-i18n xeokit-marquee xeokit-btn btnToHide fixedWidthHeightTooltipBtn fas fa-object-group fa-2x disabled" data-xeokit-i18ntip="toolbar.marqueeSelectTip" data-tippy-content="Marquee select objects" style="display:none;"></button> -->

<!-- Measure distance tool button -->
        <button type="button" class="xeokit-i18n xeokit-measure-distance xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-ruler fa-2x disabled" data-xeokit-i18ntip="toolbar.measureDistanceTip" data-tippy-content="Measure distance"></button>  
          <!-- Measure angle tool button -->
        <button type="button" class="xeokit-i18n xeokit-measure-angle xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-ruler-combined fa-2x disabled" data-xeokit-i18ntip="toolbar.measureAngleTip" data-tippy-content="Measure angle"></button>
        <!-- Start Device Orientation -->
        <!--<button type="button" class="xeokit-i18n xeokit-deviceOrientation xeokit-btn fixedWidthHeightTooltipBtn fa fa-solid fa-compact-disc fa-2x" data-xeokit-i18ntip="toolbar.deviceOrientationNav" data-tippy-content="Device Orientation Nav" style="display:none;"></button> -->  
<!-- angle tool button -->
       <!-- <button type="button" class="xeokit-i18n xeokit-mesure xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-angle-right fa-2x disabled" data-xeokit-i18ntip="toolbar.mesureObjectsTip" data-tippy-content="Angle mesure" style="display:none;"></button>-->
<!-- undo mesure button -->
		<button type="button" class="xeokit-i18n xeokit-undo xeokit-btn btnToHide fixedWidthHeightTooltipBtn fa fa-undo-alt fa-2x " data-xeokit-i18ntip="toolbar.undoTip" data-tippy-content="Effacer les mesures"></button> 		
        <!-- section tool button -->
        <button type="button" class="xeokit-i18n xeokit-section xeokit-btn fa btnToHide longFixedWidthHeightTooltipBtn fa-cut fa-2x disabled" data-xeokit-i18ntip="toolbar.sliceObjectsTip" data-tippy-content="Slice objects">
        ...
        <!-- Shadow Tool(SAO) button-->
        <button type="button" class="xeokit-i18n xeokit-setShadowOnOff btnToHide fixedWidthHeightTooltipBtn xeokit-btn fa fa-solid fa-sun fa-2x" data-xeokit-i18ntip="toolbar.setShadowOnOff" data-tippy-content="On/Off Shadow (Performance increase)" style="background-color:#1d2453"></button>
        <!-- Xrayed On/Off button-->
        <button type="button" class="xeokit-i18n xeokit-setXrayedOnOff btnToHide fixedWidthHeightTooltipBtn xeokit-btn fa fa-brands fa-codepen fa-2x" data-xeokit-i18ntip="toolbar.setXrayedOnOff" data-tippy-content="On/Off Xrayed" style="background-color:#0061A7"></button>
        <!-- annotations button-->
        <button type="button" class="xeokit-i18n xeokit-enableAnnotations btnToHide fixedWidthHeightTooltipBtn xeokit-btn fa fa-solid fa-location-dot fa-2x" data-xeokit-i18ntip="toolbar.enableAnnotations" data-tippy-content="Annotations" style="background-color:#0061A7;"></button>
        <!-- expand button-->
        <button type="button" class="xeokit-i18n xeokit-expandBimViewerBtns fixedWidthHeightTooltipBtn xeokit-btn fa fa-solid fa-caret-left fa-2x" data-xeokit-i18ntip="toolbar.expandBimViewerBtns" data-tippy-content="Réduire barre d'outils" style="background-color:#0061A7;"></button>    
        <!-- StoreysMap button -->
        <!-- <button type="button" class="xeokit-i18n xeokit-startBuildStoreysMap fixedWidthHeightTooltipBtn xeokit-btn fa fa-solid fa-layer-group fa-2x" data-xeokit-i18ntip="toolbar.startBuildStoreysMap" data-tippy-content="Plan Etages" style="background-color:#0061A7;"></button>  -->  
        <!-- Lights button -->
        <!-- <button type="button" class="xeokit-i18n xeokit-enableLights fixedWidthHeightTooltipBtn xeokit-btn fa fa-regular fa-lightbulb fa-2x" data-xeokit-i18ntip="toolbar.enableLights" data-tippy-content="Eclairage Dynamique" style="background-color:#0061A7;"></button>    -->
...
class BIMViewer extends Controller {
    ...
    constructor(server, cfg = {}) {
        ...
        window.removedObjects = []; //sam ajout
        ...
        window.firstPersonMode = this._firstPersonMode;
       ...
       /*  this._selectionTool = new SelectionTool(this, {
			...
			undoBtnElement: toolbarElement.querySelector(".xeokit-undo"),
            active: false
        }); */
       ...
       /*  this._marqueeSelectionTool = new MarqueeSelectionTool(this, {
        ...
        this.ifMobileDisplay(toolbarElement);
        this.setShadowOnOff(toolbarElement);
        this.setXrayedOnOff(toolbarElement);
        this.addAnnotationOnClickHandler = null;
        this.isAnnotationsEnabled = false;
        this.isLightsEnabled = false;
        //this.enableAddingAnnotations();
        this.storeysMapActive = false;


       /*  toolbarElement.querySelector(".xeokit-startBuildStoreysMap").addEventListener("click", (event) => {
            if(!this.storeysMapActive){
                toolbarElement.querySelector(".xeokit-startBuildStoreysMap").style.backgroundColor = "#1d2453";
                this.storeysMapActive = true;
            }else{  
                toolbarElement.querySelector(".xeokit-startBuildStoreysMap").style.backgroundColor = "#0061A7";
                this.storeysMapActive = false;
            }

        });
   this.startBuildStoreysMap(toolbarElement);   */

        //this.enableLights(toolbarElement);
        this.enableAnnotations(toolbarElement);
        this.expandBimViewerBtns(toolbarElement);
        this._initConfigs();
        this.setControlsEnabled(false);
        this.resizeToolbar();
    ...
    _customizeViewer() {
        ...
        scene.highlightMaterial.fillColor = [0.9294117647, 0.96470588235, 0.18431372549];
        ...
        this.viewer.cameraControl.touchDollyRate = 0.1; //modifié le 22/02/24 
    ...
    _initConfigs() {
        this.setConfigs({
            ...
            "saoKernelRadius": 100,
            "edgesEnabled": true,
            "entityOffsetsEnabled":true, //ajout sam
            "xrayContext": true,
            "xrayPickable": false,
    ...
    undoHideObjects(){
        const viewer = this.viewer;
     	...
     	document.addEventListener('keydown', function(event) { //sam ajout
            event.preventDefault();
            ...
            if (event.ctrlKey && event.key === 'z') {
              ...
              keyboardEvent[initMethod](
                ...
                false, // shiftKey
                false, // metaKey
                88, // keyCode: unsigned long - the virtual key code, else 0
                0, // charCode: unsigned long - the Unicode character associated with the depressed key, else 0
              );
              document.dispatchEvent(keyboardEvent);
              console.log("window.removedObjects",window.removedObjects);
                if (window.removedObjects.length > 0) {
                    window.removedObjects[window.removedObjects.length - 1].visible = true;
                    viewer.scene.setObjectsSelected(window.removedObjects[window.removedObjects.length - 1].id, false);
                    window.removedObjects.pop();
                }
            }
          });
     	
     }
      setShadowOnOff(toolbarElement){
        const viewer = this.viewer
        toolbarElement.querySelector(".xeokit-setShadowOnOff").addEventListener("click", (event) => {
            viewer.scene.sao.enabled = !viewer.scene.sao.enabled;
            viewer.scene.edgeMaterial.edges = !viewer.scene.edgeMaterial.edges;
            //saoAndEdgesDisabled = true;
            if(viewer.scene.sao.enabled){
                toolbarElement.querySelector(".xeokit-setShadowOnOff").style.backgroundColor = "#1d2453";
            }else{
                toolbarElement.querySelector(".xeokit-setShadowOnOff").style.backgroundColor = "#0061A7";
            }
            this.capteursDemo(); //Test
            event.preventDefault();
        });      	
     } 
     setXrayedOnOff(toolbarElement){
        console.log("this._objectsKdTree3",this._objectsKdTree3)
        const viewer = this.viewer;
        console.log("this.isXrayedEnabled",this.isXrayedEnabled);
        toolbarElement.querySelector(".xeokit-setXrayedOnOff").addEventListener("click", (event) => {
            if(this.isXrayedEnabled == undefined || this.isXrayedEnabled == true){
                
                viewer.scene.setObjectsVisible(viewer.scene.xrayedObjectIds, false);
                toolbarElement.querySelector(".xeokit-setXrayedOnOff").style.backgroundColor = "#0061A7";
                this.isXrayedEnabled = false;

            }else{
                var invisiblesObj = [];
                for(var a in viewer.scene.objectIds){
                    if(viewer.scene.visibleObjectIds.indexOf(viewer.scene.objectIds[a]) == -1){
                        invisiblesObj.push(viewer.scene.objectIds[a]);
                    }                
                }
                viewer.scene.setObjectsVisible(invisiblesObj, true);
                viewer.scene.setObjectsXRayed(invisiblesObj, true);
                viewer.scene.setObjectsVisible(viewer.scene.xrayedObjectIds, true);
                toolbarElement.querySelector(".xeokit-setXrayedOnOff").style.backgroundColor = "#1d2453";
                this.isXrayedEnabled = true;
            }
     ...
     enableAnnotations(toolbarElement){
        console.log("enableAnnotations")
        const viewer = this.viewer;
        console.log("this.isAnnotationsEnabled",this.isAnnotationsEnabled);
        this.enableAddingAnnotations();
        window.toolbarElem = toolbarElement;

        toolbarElement.querySelector(".xeokit-enableAnnotations").addEventListener("click", (event) => {
            if(this.isAnnotationsEnabled == false){
                toolbarElement.querySelector(".xeokit-enableAnnotations").style.backgroundColor = "#1d2453";
                this.isAnnotationsEnabled = true;

            }else{
                toolbarElement.querySelector(".xeokit-enableAnnotations").style.backgroundColor = "#0061A7";
                this.isAnnotationsEnabled = false;
            }
     ...
     expandBimViewerBtns(toolbarElement){
        toolbarElement.querySelector(".xeokit-expandBimViewerBtns").addEventListener("click", (event) => {
          var btnExpand = window.toolbarElem.querySelector(".xeokit-expandBimViewerBtns")
        var btns = window.toolbarElem.querySelectorAll(".btnToHide");
        console.log("btns",btns);
        for(var a in btns){
          if(btns[a].style){
            if(btns[a].classList.value.indexOf("btnHidden") != -1){
              if(btns[a].classList){
                btns[a].classList.remove("btnHidden");
              }
              btns[a].style.display = "inline-block";              
              btnExpand.classList.remove("fa-caret-right") ;
              btnExpand.classList.add("fa-caret-left") ;
            
            }else{
              if(btns[a].classList)
                btns[a].classList.add("btnHidden");
                btnExpand.classList.remove("fa-caret-left") ;
                btnExpand.classList.add("fa-caret-right") ;
            }
          }
        }
          ...
          for(var a in btns){
            ...
            if (window.matchMedia('(pointer: coarse)').matches) {
                var toolbarElement = window.toolbarElem;
                toolbarElement.querySelector(".xeokit-section").style.display = "none";
                //toolbarElement.querySelector(".xeokit-measure").style.display = "none";
                toolbarElement.querySelector(".xeokit-measure-angle").style.display = "none";
                toolbarElement.querySelector(".xeokit-measure-distance").style.display = "none";
                toolbarElement.querySelector(".xeokit-undo").style.display = "none";
            }
            event.preventDefault();
    ...
    /*  startBuildStoreysMap(toolbarElement){
        toolbarElement.querySelector(".xeokit-startBuildStoreysMap").addEventListener("click", (event) => {
            document.querySelector("#storeys").style.display = "block";
     ...
     enableLights(toolbarElement){
        var viewer = this.viewer;
        toolbarElement.querySelector(".xeokit-enableLights").addEventListener("click", (event) => {
            if(this.isLightsEnabled == false){
                toolbarElement.querySelector(".xeokit-enableLights").style.backgroundColor = "#1d2453";
                this.isLightsEnabled = true;
                var lightEnabled = this.isLightsEnabled;
                const scene = this.viewer.scene;
		        var objects = scene.objects;
                for (var i in objects)
                {
                    var oo = objects[i];
                    for(var m in oo.meshes){
                        var mesh = oo.meshes[m];
                        if (mesh.material && mesh.material.diffuseMap ) {
                            if (mesh.material.diffuseMap) {
                                console.log("diffuseMap",mesh.material.diffuseMap);
                                mesh.material.diffuseMap.src  = "../images/fyre_hydrant/fire_hydrant_Base_Color.png";
                                mesh.material.diffuseMap = new Texture(viewer.scene, {
                                    src: "../images/fyre_hydrant/fire_hydrant_Base_Color.png"
                                });
                            }
                        }
                    }
                ...
                toolbarElement.querySelector(".xeokit-enableLights").style.backgroundColor = "#0061A7";
                this.isLightsEnabled = false;
                //viewer.scene.clearLights();
               // this.bimViewer.resetView();
                //viewer.scene.camera.destroy();
     ...
     ifMobileDisplay(toolbarElement){
        console.log("this.isMobile",this.isMobile);

        if(this.isMobile){
            console.log("isMobile");
            //toolbarElement.querySelector(".xeokit-startBuildStoreysMap").style.display = "none";
            toolbarElement.querySelector(".xeokit-section").style.display = "none";
           // toolbarElement.querySelector(".xeokit-mesure").style.display = "none";
            toolbarElement.querySelector(".xeokit-measure-angle").style.display = "none";
            toolbarElement.querySelector(".xeokit-measure-distance").style.display = "none";
            toolbarElement.querySelector(".xeokit-undo").style.display = "none";
        }else{
     ...
     resizeToolbar(){
        const resizableElement = this.viewer.scene.canvas.canvas;
        
        // Créez une instance de ResizeObserver
        const resizeObserver = new ResizeObserver(entries => {
            for (let entry of entries) {
                // La fonction sera exécutée à chaque fois que l'élément change de taille
                //console.log('Taille changée:', entry.contentRect.width, entry.contentRect.height);
                console.log("CANVAS XEOKIT : width = ",entry.contentRect.width, " & height = ",entry.contentRect.height)
                if(entry.contentRect.width < 810){
                    var toolbar = document.querySelector(".xeokit-toolbar");
